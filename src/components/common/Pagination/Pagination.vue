    ...
    <ul class="inline-flex -space-x-px">
      ...
      <li v-for="index in pagesToDisplay" :key="index">
        <button
          ...
          :class="{
            'text-blue-600 dark:text-white bg-blue-50 dark:bg-gray-700': index === modelValue
          }"
        >
          {{ index }}
        </button>
...
import IncreaseIcon from '@/components/icons/DecreaseIcon.vue'
